      ...
      {open && (
        ...
        >
          ...
          <a
            ...
            role="menuitem"
            onClick={() => setOpen(false)}
            className="mt-2 flex items-center justify-center gap-2 rounded-full px-3.5 py-2.5 text-[13.5px] font-semibold tracking-[-0.01em] text-white transition hover:opacity-90"
