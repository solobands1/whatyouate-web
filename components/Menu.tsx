  ...
  return (
    <div ref={wrap} className="relative">
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 top-12 w-56 overflow-hidden rounded-2xl bg-[#F2F7FE] p-2 ring-1 ring-[#16233B]/[0.08]"
        ...
        >
          {LINKS.map((l) => (
            <a
              ...
              className="flex items-center rounded-xl px-3.5 py-2.5 text-[15px] font-medium text-[#16233B] transition hover:bg-white/70"
            >
              {l.label}
            </a>
          ))}
          ...
          <a
            ...
            role="menuitem"
            onClick={() => setOpen(false)}
            className="mt-1.5 flex items-center justify-center gap-2.5 rounded-full px-3.5 py-3 text-[15px] font-semibold tracking-[-0.01em] text-white transition hover:opacity-90"
