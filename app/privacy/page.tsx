...
function H3({ children }: { children: React.ReactNode }) {
  return (
    <h3 style={{ marginTop: 16, marginBottom: 4, fontSize: 11, fontWeight: 600, letterSpacing: "0.06em", textTransform: "uppercase", color: "#9CA3AF" }}>
      {children}
    </h3>
  );
}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
          ...
          <Section title="26. Contact">
            <p>
              ...
              <a href="mailto:hello@whatyouate.app" style={{ color: "#6FA8FF", textDecoration: "none" }}>
