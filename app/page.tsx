    ...
    <div className="min-h-screen bg-[#0c0c0c] text-white overflow-x-hidden" style={{ fontFamily: "var(--font-geist-sans), system-ui, sans-serif" }}>
      ...
      >
        <div className="flex flex-col items-center md:items-start text-center md:text-left max-w-[440px]">
          <div className="hero-1 inline-flex items-center gap-1.5 rounded-full border border-white/10 bg-white/5 px-3.5 py-2.5 text-[11px] font-medium text-white/50" style={{ marginBottom: 38 }}>
          ...
          <p className="hero-3 text-[18px] leading-[1.7] text-white/45 max-w-[360px]" style={{ marginBottom: 44 }}>
